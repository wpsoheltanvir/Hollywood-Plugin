...
class PHTF_Spa_Model_Slider_Widget extends PHTF_Spa_Series_Slider_Widget {
	...
	private function register_model_style_controls() {
		...
		$this->add_responsive_control( 'price_footnote_size', [ 'label' => esc_html__( 'Footnote Size', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::SLIDER, 'size_units' => [ 'em', 'px' ], 'range' => [ 'em' => [ 'min' => 0.5, 'max' => 2, 'step' => 0.01 ], 'px' => [ 'min' => 8, 'max' => 32 ] ], 'default' => [ 'size' => 0.75, 'unit' => 'em' ], 'selectors' => [ '{{WRAPPER}} .phtf-model-single-hero__price .phtf-price-note-trigger sup' => 'font-size: {{SIZE}}{{UNIT}};' ] ] );
		$this->add_responsive_control( 'price_footnote_offset', [ 'label' => esc_html__( 'Footnote Top Offset', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::SLIDER, 'size_units' => [ 'em', 'px' ], 'range' => [ 'em' => [ 'min' => -1, 'max' => 1, 'step' => 0.05 ], 'px' => [ 'min' => -20, 'max' => 20 ] ], 'default' => [ 'size' => -0.35, 'unit' => 'em' ], 'selectors' => [ '{{WRAPPER}} .phtf-model-single-hero__price .phtf-price-note-trigger sup' => 'position: relative; top: {{SIZE}}{{UNIT}};' ] ] );
		$this->add_responsive_control( 'price_footnote_horizontal_offset', [ 'label' => esc_html__( 'Footnote Left / Right Offset', 'perfect-hot-tub-finder' ), 'description' => esc_html__( 'Use a negative value to move left or a positive value to move right.', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::SLIDER, 'size_units' => [ 'em', 'px' ], 'range' => [ 'em' => [ 'min' => -2, 'max' => 2, 'step' => 0.05 ], 'px' => [ 'min' => -40, 'max' => 40 ] ], 'default' => [ 'size' => 0, 'unit' => 'em' ], 'selectors' => [ '{{WRAPPER}} .phtf-model-single-hero__price .phtf-price-note-trigger sup' => 'position: relative; left: {{SIZE}}{{UNIT}};' ] ] );
		$this->add_responsive_control( 'model_actions_top_spacing', [ 'label' => esc_html__( 'Button Top Spacing', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::SLIDER, 'size_units' => [ 'px', 'em', 'rem' ], 'range' => [ 'px' => [ 'min' => 0, 'max' => 100 ], 'em' => [ 'min' => 0, 'max' => 6, 'step' => 0.1 ], 'rem' => [ 'min' => 0, 'max' => 6, 'step' => 0.1 ] ], 'default' => [ 'size' => 20, 'unit' => 'px' ], 'selectors' => [ '{{WRAPPER}} .phtf-model-single-hero .phtf-series-slider__actions' => 'margin-top: {{SIZE}}{{UNIT}};' ] ] );
