...
class PHTF_Spa_Single_Best_Seat_House_Widget extends \Elementor\Widget_Base {
	...
	private function register_style_controls() {
		...
		$this->start_controls_section( 'section_style_arrows', [ 'label' => esc_html__( 'Navigation Arrows', 'perfect-hot-tub-finder' ), 'tab' => Controls_Manager::TAB_STYLE, 'condition' => [ 'show_arrows' => 'yes' ] ] );
		...
		$this->add_control( 'arrow_hover_color', [ 'label' => esc_html__( 'Hover Color', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::COLOR, 'default' => '#00263D', 'selectors' => [ '{{WRAPPER}} .phtf-best-seat__arrow:hover, {{WRAPPER}} .phtf-best-seat__arrow:focus-visible' => 'color: {{VALUE}} !important;' ] ] );
		...
		$this->add_responsive_control( 'arrow_button_size', [ 'label' => esc_html__( 'Button Size', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::SLIDER, 'size_units' => [ 'px' ], 'range' => [ 'px' => [ 'min' => 28, 'max' => 100 ] ], 'default' => [ 'size' => 48, 'unit' => 'px' ], 'tablet_default' => [ 'size' => 44, 'unit' => 'px' ], 'mobile_default' => [ 'size' => 38, 'unit' => 'px' ], 'selectors' => [ '{{WRAPPER}} .phtf-best-seat__arrow' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};' ] ] );
		$this->add_responsive_control( 'arrow_icon_size', [ 'label' => esc_html__( 'Icon Size', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::SLIDER, 'size_units' => [ 'px' ], 'range' => [ 'px' => [ 'min' => 20, 'max' => 90 ] ], 'default' => [ 'size' => 58, 'unit' => 'px' ], 'tablet_default' => [ 'size' => 52, 'unit' => 'px' ], 'mobile_default' => [ 'size' => 46, 'unit' => 'px' ], 'selectors' => [ '{{WRAPPER}} .phtf-best-seat__arrow' => 'font-size: {{SIZE}}{{UNIT}};' ] ] );
		...
		$this->add_responsive_control( 'arrow_side_offset', [ 'label' => esc_html__( 'Side Offset', 'perfect-hot-tub-finder' ), 'description' => esc_html__( 'Negative values move arrows outside the content area.', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::SLIDER, 'size_units' => [ 'px' ], 'range' => [ 'px' => [ 'min' => -120, 'max' => 80 ] ], 'default' => [ 'size' => -58, 'unit' => 'px' ], 'tablet_default' => [ 'size' => -48, 'unit' => 'px' ], 'mobile_default' => [ 'size' => -28, 'unit' => 'px' ], 'selectors' => [ '{{WRAPPER}} .phtf-best-seat' => '--phtf-best-seat-arrow-offset: {{SIZE}}{{UNIT}};' ] ] );
		$this->add_responsive_control( 'arrow_radius', [ 'label' => esc_html__( 'Border Radius', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => [ 'px', '%' ], 'selectors' => [ '{{WRAPPER}} .phtf-best-seat__arrow' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ] ] );
		$this->add_group_control( Group_Control_Border::get_type(), [ 'name' => 'arrow_border', 'selector' => '{{WRAPPER}} .phtf-best-seat__arrow' ] );
