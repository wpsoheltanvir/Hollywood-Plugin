...
class PHTF_Spa_Series_Slider_Widget extends \Elementor\Widget_Base {
	...
	private function register_responsive_style_controls() {
		...
		$this->add_responsive_control( 'responsive_gallery_height', [ 'label' => esc_html__( 'Gallery Height', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::SLIDER, 'size_units' => [ 'px', 'vh' ], 'range' => [ 'px' => [ 'min' => 240, 'max' => 900 ], 'vh' => [ 'min' => 25, 'max' => 100 ] ], 'selectors' => [ '{{WRAPPER}} .phtf-series-slider__gallery, {{WRAPPER}} .phtf-series-slider__image' => 'min-height: {{SIZE}}{{UNIT}};' ] ] );
		$this->add_responsive_control( 'responsive_image_fit', [ 'label' => esc_html__( 'Gallery Image Fit', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::SELECT, 'options' => [ 'cover' => esc_html__( 'Cover', 'perfect-hot-tub-finder' ), 'contain' => esc_html__( 'Contain', 'perfect-hot-tub-finder' ), 'fill' => esc_html__( 'Fill', 'perfect-hot-tub-finder' ) ], 'selectors' => [ '{{WRAPPER}} .phtf-series-slider__image' => 'object-fit: {{VALUE}};' ] ] );
		...
		$this->add_responsive_control( 'responsive_arrow_size', [ 'label' => esc_html__( 'Arrow Size', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::SLIDER, 'size_units' => [ 'px' ], 'range' => [ 'px' => [ 'min' => 28, 'max' => 90 ] ], 'selectors' => [ '{{WRAPPER}} .phtf-series-slider__arrow' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}}; font-size: {{SIZE}}{{UNIT}};' ] ] );
