...
class PHTF_Spa_Series_Slider_Widget extends \Elementor\Widget_Base {
	...
	private function register_complete_style_controls() {
		...
		$this->add_responsive_control( 'gallery_image_scale', [ 'label' => esc_html__( 'Image Scale', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::SLIDER, 'range' => [ 'px' => [ 'min' => 0.5, 'max' => 2, 'step' => 0.01 ] ], 'selectors' => [ '{{WRAPPER}} .phtf-series-slider__image' => 'transform: scale({{SIZE}});' ] ] );
