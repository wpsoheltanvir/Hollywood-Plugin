...
class PHTF_Spa_Series_Slider_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() { return esc_html__( 'WP P Series Hero', 'perfect-hot-tub-finder' ); }
	...
	protected function register_complete_style_controls() {
		...
		$this->add_responsive_control( 'arrow_radius', [ 'label' => esc_html__( 'Arrow Radius', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => [ 'px', '%' ], 'default' => [ 'top' => 50, 'right' => 50, 'bottom' => 50, 'left' => 50, 'unit' => '%', 'isLinked' => true ], 'selectors' => [ '{{WRAPPER}} .phtf-series-slider__arrow' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ] ] );
		$this->add_group_control( Group_Control_Border::get_type(), [ 'name' => 'arrow_border', 'selector' => '{{WRAPPER}} .phtf-series-slider__arrow' ] );
		$this->add_group_control( Group_Control_Box_Shadow::get_type(), [ 'name' => 'arrow_shadow', 'selector' => '{{WRAPPER}} .phtf-series-slider__arrow' ] );
		...
		$this->start_controls_section( 'style_navigation', [ 'label' => esc_html__( 'Thumbnails', 'perfect-hot-tub-finder' ), 'tab' => Controls_Manager::TAB_STYLE ] );
