...
class PHTF_Spa_Single_Hot_Tub_Essentials_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control( 'accent_color', [ 'label' => esc_html__( 'Accent Color', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::COLOR, 'default' => '#F26F5E', 'selectors' => [ '{{WRAPPER}} .phtf-essentials' => '--phtf-essentials-accent: {{VALUE}};' ] ] );
		$this->add_control( 'heading_color', [ 'label' => esc_html__( 'Heading Color', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::COLOR, 'default' => '#00263D', 'selectors' => [ '{{WRAPPER}} .phtf-essentials' => '--phtf-essentials-heading: {{VALUE}};' ] ] );
		$this->add_control( 'text_color', [ 'label' => esc_html__( 'Text Color', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::COLOR, 'default' => '#7A7A7A', 'selectors' => [ '{{WRAPPER}} .phtf-essentials' => '--phtf-essentials-text: {{VALUE}};' ] ] );
