...
class PHTF_Spa_Single_Hot_Tub_Essentials_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control( 'accent_color', [ 'label' => esc_html__( 'Accent Color', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::COLOR, 'global' => [ 'default' => 'globals/colors?id=secondary' ], 'default' => '#85D9DE', 'selectors' => [ '{{WRAPPER}} .phtf-essentials' => '--phtf-essentials-accent: {{VALUE}};' ] ] );
