...
class PHTF_Spa_Single_Hot_Tub_Essentials_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_responsive_control( 'arrow_icon_size', [ 'label' => esc_html__( 'Arrow Icon Size', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::SLIDER, 'size_units' => [ 'px' ], 'range' => [ 'px' => [ 'min' => 16, 'max' => 90 ] ], 'default' => [ 'size' => 58, 'unit' => 'px' ], 'tablet_default' => [ 'size' => 52, 'unit' => 'px' ], 'mobile_default' => [ 'size' => 46, 'unit' => 'px' ], 'selectors' => [ '{{WRAPPER}} .phtf-essentials__arrow' => 'font-size: {{SIZE}}{{UNIT}};' ] ] );
		$this->add_responsive_control( 'arrow_box_size', [ 'label' => esc_html__( 'Arrow Box Size', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::SLIDER, 'size_units' => [ 'px' ], 'range' => [ 'px' => [ 'min' => 24, 'max' => 100 ] ], 'default' => [ 'size' => 48, 'unit' => 'px' ], 'tablet_default' => [ 'size' => 44, 'unit' => 'px' ], 'mobile_default' => [ 'size' => 38, 'unit' => 'px' ], 'selectors' => [ '{{WRAPPER}} .phtf-essentials__arrow' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};' ] ] );
		$this->add_responsive_control( 'arrow_padding', [ 'label' => esc_html__( 'Padding', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => [ 'px', 'em' ], 'selectors' => [ '{{WRAPPER}} .phtf-essentials__arrow' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ] ] );
		$this->add_responsive_control( 'arrow_border_width', [ 'label' => esc_html__( 'Border Width', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => [ 'px' ], 'default' => [ 'top' => 0, 'right' => 0, 'bottom' => 0, 'left' => 0, 'unit' => 'px', 'isLinked' => true ], 'selectors' => [ '{{WRAPPER}} .phtf-essentials__arrow' => 'border-style: solid; border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ] ] );
		$this->add_responsive_control( 'arrow_border_radius', [ 'label' => esc_html__( 'Border Radius', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => [ 'px', '%' ], 'default' => [ 'top' => 0, 'right' => 0, 'bottom' => 0, 'left' => 0, 'unit' => 'px', 'isLinked' => true ], 'selectors' => [ '{{WRAPPER}} .phtf-essentials__arrow' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ] ] );
		$this->add_responsive_control( 'arrow_vertical_position', [ 'label' => esc_html__( 'Vertical Position', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::SLIDER, 'size_units' => [ '%' ], 'range' => [ '%' => [ 'min' => 10, 'max' => 90 ] ], 'default' => [ 'size' => 55, 'unit' => '%' ], 'mobile_default' => [ 'size' => 47, 'unit' => '%' ], 'selectors' => [ '{{WRAPPER}} .phtf-essentials__arrow' => 'top: {{SIZE}}{{UNIT}};' ] ] );
		$this->add_responsive_control( 'arrow_side_offset', [ 'label' => esc_html__( 'Arrow / Content Gap', 'perfect-hot-tub-finder' ), 'description' => esc_html__( 'Use a negative value to move arrows outside the content area.', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::SLIDER, 'size_units' => [ 'px' ], 'range' => [ 'px' => [ 'min' => -120, 'max' => 80 ] ], 'default' => [ 'size' => -58, 'unit' => 'px' ], 'tablet_default' => [ 'size' => -48, 'unit' => 'px' ], 'mobile_default' => [ 'size' => -28, 'unit' => 'px' ], 'selectors' => [ '{{WRAPPER}} .phtf-essentials' => '--phtf-essentials-arrow-offset: {{SIZE}}{{UNIT}};' ] ] );
		...
		$this->add_control( 'arrow_color', [ 'label' => esc_html__( 'Arrow Color', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::COLOR, 'global' => [ 'default' => 'globals/colors?id=secondary' ], 'default' => '#85D9DE', 'selectors' => [ '{{WRAPPER}} .phtf-essentials__arrow' => 'color: {{VALUE}} !important;' ] ] );
		$this->add_control( 'arrow_background_color', [ 'label' => esc_html__( 'Background Color', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::COLOR, 'default' => 'rgba(255,255,255,0)', 'selectors' => [ '{{WRAPPER}} .phtf-essentials__arrow' => 'background-color: {{VALUE}} !important;' ] ] );
		$this->add_control( 'arrow_border_color', [ 'label' => esc_html__( 'Border Color', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::COLOR, 'default' => 'rgba(255,255,255,0)', 'selectors' => [ '{{WRAPPER}} .phtf-essentials__arrow' => 'border-color: {{VALUE}};' ] ] );
		$this->add_group_control( Group_Control_Box_Shadow::get_type(), [ 'name' => 'arrow_box_shadow', 'selector' => '{{WRAPPER}} .phtf-essentials__arrow' ] );
		$this->end_controls_tab();
		$this->start_controls_tab( 'arrow_hover_tab', [ 'label' => esc_html__( 'Hover', 'perfect-hot-tub-finder' ) ] );
		$this->add_control( 'arrow_hover_color', [ 'label' => esc_html__( 'Arrow Color', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::COLOR, 'global' => [ 'default' => 'globals/colors?id=primary' ], 'default' => '#00263D', 'selectors' => [ '{{WRAPPER}} .phtf-essentials__arrow:hover, {{WRAPPER}} .phtf-essentials__arrow:focus-visible' => 'color: {{VALUE}} !important;' ] ] );
		$this->add_control( 'arrow_hover_background_color', [ 'label' => esc_html__( 'Background Color', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::COLOR, 'default' => 'rgba(255,255,255,0)', 'selectors' => [ '{{WRAPPER}} .phtf-essentials__arrow:hover, {{WRAPPER}} .phtf-essentials__arrow:focus-visible' => 'background-color: {{VALUE}} !important;' ] ] );
		$this->add_control( 'arrow_hover_border_color', [ 'label' => esc_html__( 'Border Color', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::COLOR, 'default' => 'rgba(255,255,255,0)', 'selectors' => [ '{{WRAPPER}} .phtf-essentials__arrow:hover, {{WRAPPER}} .phtf-essentials__arrow:focus-visible' => 'border-color: {{VALUE}};' ] ] );
		$this->add_group_control( Group_Control_Box_Shadow::get_type(), [ 'name' => 'arrow_hover_box_shadow', 'selector' => '{{WRAPPER}} .phtf-essentials__arrow:hover, {{WRAPPER}} .phtf-essentials__arrow:focus-visible' ] );
		$this->end_controls_tab();
		$this->start_controls_tab( 'arrow_active_tab', [ 'label' => esc_html__( 'Active', 'perfect-hot-tub-finder' ) ] );
		$this->add_control( 'arrow_active_color', [ 'label' => esc_html__( 'Arrow Color', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::COLOR, 'global' => [ 'default' => 'globals/colors?id=primary' ], 'default' => '#00263D', 'selectors' => [ '{{WRAPPER}} .phtf-essentials__arrow:active' => 'color: {{VALUE}} !important;' ] ] );
		$this->add_control( 'arrow_active_background_color', [ 'label' => esc_html__( 'Background Color', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::COLOR, 'default' => 'rgba(255,255,255,0)', 'selectors' => [ '{{WRAPPER}} .phtf-essentials__arrow:active' => 'background-color: {{VALUE}} !important;' ] ] );
		$this->add_control( 'arrow_active_border_color', [ 'label' => esc_html__( 'Border Color', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::COLOR, 'default' => 'rgba(255,255,255,0)', 'selectors' => [ '{{WRAPPER}} .phtf-essentials__arrow:active' => 'border-color: {{VALUE}};' ] ] );
		$this->add_group_control( Group_Control_Box_Shadow::get_type(), [ 'name' => 'arrow_active_box_shadow', 'selector' => '{{WRAPPER}} .phtf-essentials__arrow:active' ] );
		$this->end_controls_tab();
		$this->end_controls_tabs();
		$this->add_responsive_control( 'arrow_disabled_opacity', [ 'label' => esc_html__( 'Disabled Opacity', 'perfect-hot-tub-finder' ), 'type' => Controls_Manager::SLIDER, 'range' => [ 'px' => [ 'min' => 0, 'max' => 1, 'step' => .01 ] ], 'default' => [ 'size' => .35 ], 'selectors' => [ '{{WRAPPER}} .phtf-essentials__arrow:disabled' => 'opacity: {{SIZE}};' ] ] );
		$this->end_controls_section();
